...
def angle_at_corners(item,box_type): #main function
    ...
    corners[0][1] = item.point[1]*division + item.dimensions[1]
    corners[0][2] = item.point[2]*division + item.dimensions[2]
    corners[1][0] = item.point[0]*division + item.dimensions[0]# right-top point
    corners[1][1] = item.point[1]*division + item.dimensions[1]
    corners[1][2] = item.point[2]*division + item.dimensions[2] 
    corners[2][0] = item.point[0]*division + item.dimensions[0]# right-botton point
    corners[2][1] = item.point[1]*division
    corners[2][2] = item.point[2]*division + item.dimensions[2]
    corners[3][0] = item.point[0]*division                    # left-botton point
    corners[3][1] = item.point[1]*division
    corners[3][2] = item.point[2]*division + item.dimensions[2]
    # print(corners)
