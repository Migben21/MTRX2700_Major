...
int main() {
    ...
    int i = 0;
    for (i=0; i < 27; i++) {
        point_compare(set_1[i], set_2[i], &array[i], i);
    }
...
points
inc array
void single_compare(int data1, int data2, int *storage_array_entry);
    *storage_array_entry = result;
 function thats take the address of a single int in the array and modifies it
 for(int i = 0; i < 27; i++){
